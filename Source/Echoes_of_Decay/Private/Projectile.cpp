...
AProjectile::AProjectile()
{
    ...
    MeshComponent->SetCollisionObjectType(ECC_PhysicsBody); // Assure-toi que l'objet est d�tectable
    ...
    UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
    ...
    // Si c'est un ennemi, on applique les d�g�ts
    ...
    // D�truire le projectile quel que soit l'impact
    Destroy();
}